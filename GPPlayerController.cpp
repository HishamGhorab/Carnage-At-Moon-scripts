...
AGPPlayerController::AGPPlayerController()
{
	...
	//UPlayerInput::AddEngineDefinedAxisMapping(FInputAxisKeyMapping("LookUpGp", EKeys::MouseY, LookUpSensitivity));
}
...
void AGPPlayerController::BeginPlay()
{
	...
	//Joel added cuz had problems finding playercontroller pls don't break my legs :)
	AGameModePrototype* GameMode = (AGameModePrototype*)GetWorld()->GetAuthGameMode();
	GameMode->PlayerControllerRef = this;
}
